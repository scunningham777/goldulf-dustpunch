...
export class SiteScene extends Phaser.Scene {
    ...
    createHero() {
        ...
        this.hero = new Hero(
            ...
            heroStartYInPixels,
            this,
            HERO_VELOCITY * (HERO_DEBUG_VELOCITY_MODES.includes(PLAY_MODE) ? HERO_DEBUG_VELOCITY_MULTIPLIER : 1),
            heroStartDirection,
            heroMvtCtrl
        );
